...
const Dashboard = (props) => {
    ...
    useEffect(() => {
      ...
      if (isMounted)
      {
        ...
        // };
         return () => { isMounted = false; source.cancel("Cancelling in cleanup"); };
...
useEffect(() => {
     ...
     if(focus==false) 
      ...
      return () => { setBottomAdandTimer(); isMounted = false; };
 ...
 const renderPage = (image, index) => {
  ...
  return (
    ...
    <ScrollView style={{height:height,marginBottom:20, }}>
         ...
         <View style={{flex:1, flexDirection:"row", backgroundColor:"#fff", height:160, marginBottom:10}}> 
            ...
            <View style={{flex : 1, backgroundColor:"#fff",  padding:2, borderRadius:20, borderColor:'fff'}}>
                ...
                <View style={{backgroundColor:'#FFEDED', height:30, borderRadius:13, marginTop:10, justifyContent:'center', color:'#000' ,alignItems:'center', borderColor:'#F00', borderWidth:2,}}>
        ...
        <View style={{flex:1, flexDirection:"row", backgroundColor:"#fff", height:160, marginBottom:10}}> 
           ...
           <View style={{flex : 1, backgroundColor:"#fff",  padding:2, borderRadius:20, borderColor:'fff'}} >
            <Pressable onPress={()=>{ props.navigation.navigate('ExternalNewsPaper', {newspaperlink: 'https://youtube.com/channel/UCptBapmgpg9Kbkl-q8SarbA'}) ;console.log("Pressed.....")}}>
                <View style={{flexDirection: 'column', maxHeight:140, height:120}}>
            ...
            style={{flex:1, backgroundColor:'#f00', height:55, marginLeft:10, marginRight:10, borderRadius:37, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', }}>
